                            ...
                            children: [
                              Padding(
                                ...
                                child: IconButton(
                                    onPressed: () {
                                      providerF!.AddData(
                                          providerT!.data!, providerT!.index);
                              ...
                              Padding(
                                ...
                                child: IconButton(
                                    onPressed: () {
                                      ...
                                      providerF!.changeplay(
                                          !providerF!.data!.isplay!);
                                    },
                                    icon: Icon(
                            ...
                            return Column(
                              children: [
                                Slider(
                                  ...
                                  max: providerT!.songDuration.inSeconds
                                      .toDouble(),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        "${position.inMinutes < 10 ? "0${position.inMinutes}" : "${position.inMinutes}"} : ${(position.inSeconds - position.inMinutes * 60) < 10 ? "0${position.inSeconds - position.inMinutes * 60}" : "${position.inSeconds - position.inMinutes * 60}"}   /  ",
                                        style: TextStyle(
                                            color: Colors.white, fontSize: 20),
                                      ),
                                      Text(
                                          "${providerT!.songDuration.inMinutes < 10 ? "0${providerT!.songDuration.inMinutes}" : "${providerT!.songDuration.inMinutes}"} : ${(providerT!.songDuration.inSeconds - providerT!.songDuration.inMinutes * 60) < 10 ? "0${providerT!.songDuration.inSeconds - providerT!.songDuration.inMinutes * 60}" : "${providerT!.songDuration.inSeconds - providerT!.songDuration.inMinutes * 60}"}",
                                          style: TextStyle(
                                              color: Colors.white,
                                              fontSize: 20))
                                    ],
